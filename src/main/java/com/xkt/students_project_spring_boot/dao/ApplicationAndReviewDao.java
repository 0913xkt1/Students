...
public interface ApplicationAndReviewDao {
    /**
     * 学生所有成绩
     *
     * param stuId
     ...
     * return
     */
    List<Quantification> selectStudentQuan(Integer stuId);
    //添加成绩
    public String addexcelScore(Score score);
    //    教师查看班级成绩
...
//添加量化
    public String addexcelQuan(Quantification quantification);

    //批量删除量化

    public void  deleteQuans( Integer [] quanId);
    //删除量化
...
//换宿查看
    ApplicationDorm findapplicationClassByad(Integer laId);
//    换班查看
    ApplicationClass findClassApplicationBycaId(Integer caId);
//    更改学生信息
    void updateStudent6(Student student);
}